            ...
            <div class="single-item">
              ...
              <div class="card" style="width: 18rem;">
                <a href="{{route('chitietsp',$pro->id)}}"><img src="Uploads/{{$pro->image}}" height="400px"
                  ...
                  <div class="card-body">
                    <center><h5 class="card-title">{{$pro->Tensanpham}}</h5></center>
                    @if($pro->GiaKM==0)
                    <center><p class="card-text" style="color: red; ">{{number_format($pro->Giasp)}} vnđ</p></center>
                    @else
                    <p class="card-text" style="text-decoration: line-through; float: left;">{{number_format($pro->Giasp)}} vnđ</p>
                    <p class="card-text" style="color: red; float: right;">{{number_format($pro->GiaKM)}} vnđ</p>
                    @endif
                    

                    <center><button type="button" class="addcart"><a onclick="addcart({{$pro->id}})" href="javascript:" >Add to Cart</a></button></center>
                  </div>
                </div>
              </div>
            </div>
