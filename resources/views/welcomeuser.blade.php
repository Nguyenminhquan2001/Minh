...
<body class="antialiased ">
    ...
    <div class="row">
      ...
      <div class="col-md-2">
        ...
        <div class=" hidden fixeds  top-0 right-0 px-6 py-4 sm:block ">
          ...
          <button><a href="{{ url('/dashboarduser') }}"
              class="list-inline top-nav-right-list underline">{{ Auth::user()->name }}</a></button>
                <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')"
                             ...
                             <button  style="font-size:20px">  {{ __('Log Out') }}</button>
                            </x-dropdown-link>
                        </form>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <p class="pull-left"> Có {{count($san_pham)}} sản phẩm</p>
    </div>
  </div>
  <div class="py-12">
            ...
            <div class="col-md-3">
              <div class="single-item">
                ...
                <div class="card" style="width: 18rem;">
                  <a href="{{route('chitietsp',$pro->id)}}"><img src="Uploads/{{$pro->image}}" height="400px"
                      class="card-img-top" alt="..."></a>

                  <div class="card-body">
                    <center>
                      <h5 class="card-title">{{$pro->Tensanpham}}</h5>
                    </center>
                    @if($pro->GiaKM==0)
                    <center>
                      <p class="card-text" style="color: red; ">{{number_format($pro->Giasp)}} vnđ</p>
                    </center>
                    @else
                    <p class="card-text" style="text-decoration: line-through; float: left;">
                      {{number_format($pro->Giasp)}} vnđ</p>
                    <p class="card-text" style="color: red; float: right;">{{number_format($pro->GiaKM)}} vnđ</p>
                    @endif


                    <center><button type="button" class="addcart"><a onclick="addcart({{$pro->id}})"
